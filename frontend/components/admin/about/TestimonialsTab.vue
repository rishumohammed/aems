            ...
            <v-card-text>
                <v-form @submit.prevent="saveTestimonial">
                    <v-row>
                        ...
                        <v-col cols="12" md="6"><v-textarea v-model="modal.form.before_description" label="Before Brix Certifications (student's situation before joining)" rows="3" hint="Shown in the featured testimonial Before card"></v-textarea></v-col>
                        <v-col cols="12" md="6"><v-textarea v-model="modal.form.after_description" label="After Brix Certifications (outcome after joining)" rows="3" hint="Shown in the featured testimonial After card"></v-textarea></v-col>
                    </v-row>
