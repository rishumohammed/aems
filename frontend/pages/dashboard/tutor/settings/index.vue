  ...
  <v-container fluid class="pa-0">
    ...
    <div class="header-section pa-8 pb-15 mb-n10">
      <div class="d-flex align-center justify-space-between mb-2">
        <div>
          <h1 class="text-h4 font-weight-black text-white mb-1">Instructor Settings</h1>
          <p class="text-subtitle-1 text-white opacity-80">Manage your profile, expertise, and teaching preferences.</p>
        </div>
        <v-btn color="white" rounded="xl" class="text-primary font-weight-black px-6 shadow-glow" size="large" :loading="loading" @click="saveSettings">
          Save Changes
        </v-btn>
      </div>
    </div>
...
.shadow-glow {
  box-shadow: 0 10px 30px rgba(51, 65, 85, 0.3) !important;
}
