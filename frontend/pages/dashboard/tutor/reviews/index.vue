  ...
  <v-container fluid class="pa-0">
    ...
    <div class="header-section pa-8 pb-15 mb-n10">
      <div class="d-flex align-center justify-space-between mb-2">
        <div>
          <h1 class="text-h4 font-weight-black text-white mb-1">Student Reviews</h1>
          <p class="text-subtitle-1 text-white opacity-80">Monitor feedback and engage with your community.</p>
        </div>
      </div>
    </div>
    ...
    <v-container fluid class="pa-8">
      ...
      <v-card flat rounded="xl" class="border-0 shadow-soft overflow-hidden">
        ...
        <div v-else class="pa-12 text-center">
          ...
          <h3 class="text-h6 font-weight-bold text-grey-darken-1">No reviews yet</h3>
...
const stats = computed(() => [
  { title: 'Avg. Rating', value: '4.8', icon: 'mdi-star', color: 'amber-darken-2' },
