...
('contact_email', 'contact@brixify.online', 'contact', 'General contact email', FALSE),
('contact_phone', '+1234567890', 'contact', 'General contact phone number', FALSE),
('contact_address', '123 Brixify Campus, Education City', 'contact', 'Institution physical address', FALSE),
('certificate_prefix', 'BRX-CERT-', 'certificates', 'Prefix for certificate numbers', FALSE),
